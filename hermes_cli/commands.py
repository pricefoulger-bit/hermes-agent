...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("loop", "Start or inspect a Fruit-Loop project controller", "Session",
               args_hint="[start|status|docs|grill|plan|run next|complete|block|close] [name/instruction]",
               subcommands=("start", "status", "docs", "grill", "plan", "run", "complete", "block", "close")),
